...
<!---<cfelse>
    <div class="p-0 m-5 card border-dark">
        <h3 class="text-center alert alert-warning m-0 py-5">
            <b class="text-justify">Внимание!<br>Запрос неверный, обратитесь к администратору.</b>
        </h3>
    </div>
    <cfabort>--->
</cfif>
<!---<cfdump var="#userInfo#" />--->
<!---<cfoutput query="userInfo">#userInfo.user_id#</cfoutput> IS <cfoutput>#url.user_id#</cfoutput>--->
<!---<cfscript>  x = y = 1; writeDump(userInfo.recordcount); </cfscript>--->
