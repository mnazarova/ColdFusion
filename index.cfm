<cfif !structKeyExists(form, "FIELDNAMES") OR form.FIELDNAMES == 'J_USERNAME,J_PASSWORD'>
...
<cfquery datasource="DB" name="errors">
    ...
    c.name as criticalnessName, usr.surname || ' ' || usr.name as NameOfUser
    FROM error
    ...
    <cfform id="errorListForm" name="errorListForm" method="POST">
            <table class="my-3 table table-hover table-responsive-xl table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center border-white">
                        <button class="btn btn-outline-secondary btn-sm" type="submit" id="NameOfUser" name="NameOfUser">
                            <i class="fa fa-sort" aria-hidden="true"></i>
                            Пользователь
                        </button>
                    </th>
            ...
            <td class="text-center border-info">#errors.NameOfUser#</td>
